...
public class GameUIManager : MonoBehaviour
{
    ...
    public void OpenDeckBuild()
    {
        if (DeckBuildPanel != null)
        {
            ...
            foreach (var carta in FindObjectsOfType<Card>())
            {
                
                // foreach (var player in FindObjectsOfType<PlayerController>())
                // {
                //     foreach (var cartaComponente in player.playerHand)
                //     {
                //         if (cartaComponente.GetComponent<Card>().dadosCarta.id == carta.dadosCarta.id)
                //         {
                //             escurecer = false;
                //             break;
                //         }
